...
:   **Geospatially explicit (GIS).** Creates maps & spatially explicit regression models (e.g., corrects for spatial autocorrelation); familiar with analytical methods (i.e., Moran’s I)
